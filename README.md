...
- If you wonder if someone is working on an environment, you can check its deployment status in [deployments history](../../deployments) and see who is deploying to it
